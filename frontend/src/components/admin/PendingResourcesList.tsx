  ...
  return (
    <div className="space-y-4">
      {resources.map((resource) => {
        ...
        const uploadedBy = resource.uploadedBy || { displayName: 'Unknown User' };
        const course = resource.course || { name: 'Unknown Course' };
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-6 text-sm text-text-secondary mb-4">
                    ...
                    <span className="flex items-center gap-1">
                      ...
                      <strong>Uploader:</strong> {uploadedBy.displayName}
                    </span>
                  </div>
